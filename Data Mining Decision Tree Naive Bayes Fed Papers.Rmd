...
library(klaR)
text_train <- read.csv("C:/Users/Matt/Desktop/IST565/Datasets/Kaggle-digit-train.csv")
text_test <- read.csv("C:/Users/Matt/Desktop/IST565/Datasets/Kaggle-digit-test.csv")
```
