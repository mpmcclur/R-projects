...
setwd("C:/Users/Matt/Documents/dB")
...
db_arima2 <- arima(db_sales_clean, order=c(4,1,0),seasonal = list(order = c(1,1,0),maxit = 10000)) # maxit implemented to increase maximum number of iterations before convergence for the MLE
...
```
Forecasted 2019 sales are conservative: for dB Company, the predicted 2019 sales is summed at 3,774,632.90 euros, whereas Country is summed at 3,319,420.49 euros. The dB model is a gross overestimation, but the Country will have modest sales in 2019.
