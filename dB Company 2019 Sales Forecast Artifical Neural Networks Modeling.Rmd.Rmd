...
---
```{r install packages, include=FALSE,echo=TRUE,message = FALSE, warnings = FALSE}
...
```{r Data,echo=TRUE,message = FALSE, warnings = FALSE}
...
```{r Data Continued,echo=TRUE,message = FALSE, warnings = FALSE}
...
```{r dB Outliers,echo=TRUE,message = FALSE, warnings = FALSE}
...
```{r Country Outliers,echo=TRUE,message = FALSE, warnings = FALSE}
...
```{r dB Decomposition,echo=TRUE,message = FALSE, warnings = FALSE}
...
```{r Country Decomposition,echo=TRUE,message = FALSE, warnings = FALSE}
...
```{r Stationariy Test,echo=TRUE,message = FALSE, warnings = FALSE}
...
```{r dB ACF and PACF,echo=TRUE,message = FALSE, warnings = FALSE}
Acf(db_sales_clean, main='ACF')
Pacf(db_sales_clean, main='PACF')
```

```{r Country ACF and PACF,echo=TRUE,message = FALSE, warnings = FALSE}
...
```{r dB ANN 2018,echo=TRUE,message = FALSE, warnings = FALSE}
# ELM
...
```{r Country ANN 2018,echo=TRUE,message = FALSE, warnings = FALSE}
# ELM
