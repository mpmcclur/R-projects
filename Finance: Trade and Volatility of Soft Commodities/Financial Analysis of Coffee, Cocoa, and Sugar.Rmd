...
In order to expand its product line of ultrafast lasers, LaserMat Inc. is looking to invest in a commodities market for additional capital. Specifically, the company is interested in investing in soft commidities such as Arabica coffee beans, sugar, or cocoa beans. The board of LaserMat wants to take advantage of potential investment opportunities in one of these commodities to secure future funds for sustained research, design, and manufacturing of state-of-the-art picosecond lasers. LaserMat anticipates strong demand in industrial applications and academic research circles within the next decade. Thus, the more liquid assets LaserMat has, the better it can leverage its R&D resources. As a financial analyst, I have been tasked with investigating the matter and making a recommendation to the board.
...
2.  Compare all three commodities to determine their historic and future trends as well as the presence of volatility.
...
### Loss Analysis
What do the losses for each commodity look like, and how much capital would LaserMat need to invest (i.e., what is the barrier to entry)?
